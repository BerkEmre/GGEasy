...
public class BuildOpenAdapter extends BaseAdapter{
    private LayoutInflater mInflater;
    Context context;
    private List<BuildObject> buildObjects1;
    RiotApiHelper riotApiHelper=new RiotApiHelper();
    BuildOpenFragment bof;
    public BuildOpenAdapter(Activity activity, List<BuildObject> buildObjects, BuildOpenFragment bof) {
